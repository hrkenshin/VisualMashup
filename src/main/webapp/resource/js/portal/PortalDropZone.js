...
Ext.define('Ext.app.PortalDropZone', {
    ...
    notifyOver: function(dd, e, data) {
        ...
        if (portal.fireEvent('validatedrop', overEvent) !== false && portal.fireEvent('beforedragover', overEvent) !== false) {
            ...
            // TODO : ADDED BY 이승백
            dd.panel.fireEvent('dragover', overEvent);
    ...
    notifyEnter: function(dd, e, data) {
        ...
        var event = this.createEvent(dd, e, data, colIndex, overColumn);

        this.portal.fireEvent('dragenter', event);

        // TODO : ADDED BY 이승백
        dd.panel.fireEvent('dragenter', event);
    },

    notifyOut: function(dd, e, data) {
        // TODO : ADDED By 이승백 {
        var panel = dd.panel,
            c = panel.findParentByType('portalcolumn'),
            col,
            pos,
            event = this.createEvent(dd, e, data, col, c, pos !== false ? pos : c.items.getCount());

        this.portal.fireEvent('dragout', event);
        panel.fireEvent('dragout', event);
        // TODO : }
