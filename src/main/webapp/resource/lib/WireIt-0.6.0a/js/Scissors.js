...
//      this.appendTo(this._terminal.container ? this._terminal.container.layer.el : this._terminal.el.parentNode.parentNode);
      // TODO : MODIFIED BY 이승백(1-2-1 유형의 레이아웃에서 scissors 감춰지는 문제 처리)
      this.appendTo(this._terminal.extComponent ? Ext.getDom(this._terminal.extComponent.body):
          (this._terminal.container ? this._terminal.container.layer.el : this._terminal.el.parentNode.parentNode));
