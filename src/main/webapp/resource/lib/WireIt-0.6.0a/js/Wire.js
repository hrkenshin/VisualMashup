...
//	  YAHOO.util.Dom.setStyle(this.labelEl,"top",(this.min[1]+this.max[1]-this.labelEl.clientHeight)/2);
        ...
        // TODO : ADDED BY 이승백
        this.labelEl.style.left = (this.min[0]+this.max[0]-this.labelEl.clientWidth)/2 + 'px';
        this.labelEl.style.top = (this.min[1]+this.max[1]-this.labelEl.clientHeight)/2 + 12 + 'px';
	},
